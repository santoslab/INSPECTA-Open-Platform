...
// SB_QUEUE_SW_RAWETHERNETMESSAGE_IMPL_1_SIZE-1 elements.
#define SB_QUEUE_SW_RAWETHERNETMESSAGE_IMPL_1_SIZE 2
...
typedef struct sb_queue_SW_RawEthernetMessage_Impl_1 {
  ...
  // Queue of elements of type SW_RawEthernetMessage_Impl
  // (see sb_types.h) implemented as a ring buffer.
  // No initialization necessary.
  SW_RawEthernetMessage_Impl elt[SB_QUEUE_SW_RAWETHERNETMESSAGE_IMPL_1_SIZE];

} sb_queue_SW_RawEthernetMessage_Impl_1_t;
...
typedef struct sb_queue_SW_RawEthernetMessage_Impl_1_Recv {
...
} sb_queue_SW_RawEthernetMessage_Impl_1_Recv_t;
...
// dropped since the last call to sb_queue_SW_RawEthernetMessage_Impl_1_dequeue(). *data is left in
// unspecified state.
//
// If the sender ever gets ahead of a receiver by more than COUNTER_MAX,
// sb_queue_SW_RawEthernetMessage_Impl_1_dequeue will fail to count a multiple of COUNTER_MAX in
